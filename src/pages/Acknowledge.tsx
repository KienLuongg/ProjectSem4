...
const Acknowledge = () => {
  ...
  const getStudents = async () => {
    const s = await mainAxios.get(`/api/v1/student/get-student-year-info-by?bySchoolYearClassId=${idClass}&bySchoolYearId=${idYear}`);
    setStudent(s.data);
  }
  console.log(student)
  useEffect(() => {
    ...
    <div className="acknowledge ">
      <div style={{ display: "flex", padding: "16px" }}>
        <div style={{ marginRight: "14px" }}>
          <Select style={{ width: "100px", height: "38px" }} options={options} defaultValue={options[0].value} onChange={handleChange} />
        </div>
